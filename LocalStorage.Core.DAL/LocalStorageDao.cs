...
namespace LocalStorage.Core.DAL
{
    public class LocalStorageDao : ILocalStorageDao
    {
        public void SaveAesCredentions(byte[] key, byte[] iv)
        {
            ...
            // TODO:
            // добавить нужные авалониа зависимости к каждому PSL - проекту
            // тест компиляции
            // дописать реализации чтения и записи в защищенный файл для android, linux, windows
            // тест компиляции
            // дописать вызовы для нужных ОС методов чтения и записи согласно PSL (класс LocalStorageDao)
            // тест работы и корректных вызовов
        }
