...
// дешифруем токен сервера
// сохраняем зашифрованный токен сервера, url кроссплатформенно(через DI)
// сохраняем aes key и iv кроссплатформенно(через DI)
// получаем url кроссплатформенно(через DI)
// получаем aes key и ib кроссплатформенно(через DI)
// расшифровываем токен сервера
// ТЕСТ!
